...
<div class="container-fluid">
    <ul class="breadcrumb breadcrumb-tabs">
        ...
        <!--<li>
            <a href="<?php echo SERVERURLL?>/" class="btn btn-success">
...
<div class="container-fluid">
    <div class="panel panel-success">
        ...
        <form action = "<?php echo SERVERURLL;?>ajax/anteproyectofAjax.php" method = "POST" data-form = "save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
        <fieldset>

                <legend><i class="zmdi zmdi-group"></i> &nbsp; Datos del Grupo a Evaluar</legend>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Código de Grupo *</label>
                                    <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9]{1,10}" class="form-control" type="text" name="gpanteproyectof" required="" maxlength="10">
                                </div>
                            </div>
                        </div> 
                  </div>
        ...
        <fieldset>
        <legend><i class="zmdi zmdi-group"></i> &nbsp; Formato ANTEPROYECTO</legend>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><textarea name="recomendation-generalidades" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Introducción</td>
                            ...
                            <td><textarea name="recomendation-introduccion" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Justificación</td>
                            ...
                            <td><textarea name="recomendation-justificacion" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Argumentación</td>
                            ...
                            <td><textarea name="recomendation-argumentacion" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-planteamiento" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-objetivog" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-objetivoe" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Coherencia</td>
                            ...
                            <td><textarea name="recomendation-coherencia" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-alcances" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-marcoc" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Marco teórico</td>
                            ...
                            <td><textarea name="recomendation-marcot" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-estadoarte" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-impacto" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-apparea" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Metodología</td>
                            ...
                            <td><textarea name="recomendation-metodologia" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Presupuesto</td>
                            ...
                            <td><textarea name="recomendation-presupuesto" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="recomendation-productose" class="form-control" rows="4"></textarea></td>
                        </tr>
                        <tr>
                            <td>Bibliografía</td>
                            ...
                            <td><textarea name="recomendation-bibliografia" class="form-control" rows="4"></textarea></td>
                        </tr>
                    </tbody>
                </table>
            </div>
