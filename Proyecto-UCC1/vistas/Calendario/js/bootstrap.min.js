if("undefined"==typeof jQuery)throw new Error("Bootstrap's JavaScript requires jQuery");+function(a) { 
	...
	function b() {
		...
		a.fn.emulateTransitionEnd=function(b){var c=!1,d=this;a(this).one(a.support.transition.end,function(){
												c=!0
												});
												var e=function(){
...
+function(a){
	...
	b.prototype.setState=function(b){
		...
		f=d.data();b+="Text",
		f.resetText||d.data("resetText",
			d[e]()),d[e](f[b]||this.options[b]),
	...
	b.prototype.toggle=function(){
		...
		+function(a){
			...
			b.DEFAULTS={
				interval:5e3,pause:"hover",wrap:!0},b.prototype.cycle=function(b){
				...
				b.prototype.getActiveIndex=function(){
					...
					b.prototype.slide=function(b,c){
						...
						j.isDefaultPrevented()?void 0:(this.sliding=!0,f&&this.pause(),
							this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),
								this.$element.one("slid.bs.carousel",function(){var b=a(i.$indicators.children()[i.getActiveIndex()]);
									b&&b.addClass("active")
								})),
				...
				+function(a){
					...
					b.prototype.show=function(){
						if(!this.transitioning&&!this.$element.hasClass("in")){
							...
							this.transitioning=1;var f=function(){
				...
				b.prototype.hide=function(){
					if(!this.transitioning&&this.$element.hasClass("in")){
						...
						this.transitioning=1;var d=function(){
							this.transitioning=0,
				...
				f.prototype.keydown=function(b){
					if(/(38|40|27)/.test(b.keyCode)){
						...
						if(!g||g&&27==b.keyCode)return 27==b.which&&f.find(e).focus(),
							d.click();var h=" li:not(.divider):visible a",
				...
				b.prototype.show=function(b){
					...
					this.isShown||d.isDefaultPrevented()||(this.isShown=!0,
						...
						this.backdrop(function(){
							...
							c.$element.addClass("in").attr("aria-hidden",!1),c.enforceFocus();
					...
					b.prototype.hide=function(b){
						...
						this.isShown&&!b.isDefaultPrevented()&&(this.isShown=!1,
							...
							a.support.transition&&this.$element.hasClass("fade")?this.$element.one(a.support.transition.end,a.proxy(this.hideModal,
						...
						b.prototype.escape=function(){
							this.isShown&&this.options.keyboard?this.$element.on("keyup.dismiss.bs.modal",
								a.proxy(function(a){
							...
							if(this.isShown&&this.options.backdrop){
								...
								if(this.$backdrop=a('<div class="modal-backdrop '+c+'" />').appendTo(document.body),
									this.$element.on("click.dismiss.bs.modal",
										...
										this)),d&&this.$backdrop[0].offsetWidth,
						...
						+function(a){
							...
							b.DEFAULTS={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
							trigger:"hover focus",
							title:"",
							delay:0,
							html:!1,
						...
						b.prototype.init=function(b,c,d){
							this.enabled=!0,this.type=b,this.$element=a(c),
							this.options=this.getOptions(d);
							for(var e=this.options.trigger.split(" "),
								f=e.length;f--;){var g=e[f];
						...
						b.prototype.leave=function(b){
							...
							b.prototype.show=function(){
								...
								if(this.hasContent()&&this.enabled){
									...
									var e="function"==typeof this.options.placement?this.options.placement.call(this,d[0],this.$element[0]):this.options.placement,f=/\s?auto?\s?/i,g=f.test(e);g&&(e=e.replace(f,"")||"top"),d.detach().css({
										top:0,left:0,display:"block"}).addClass(e),
